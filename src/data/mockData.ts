...
export const mockComparison = {
  ...
  to: "Today",
  metrics: [
    { name: "Redness", from: 62, to: 72, direction: "increased", color: "coral" as const },
    { name: "Hydration", from: 62, to: 48, direction: "decreased", color: "aqua" as const },
    { name: "Acne", from: 35, to: 32, direction: "improved", color: "sage" as const },
    { name: "Oiliness", from: 55, to: 52, direction: "improved", color: "sun" as const },
  ],
};